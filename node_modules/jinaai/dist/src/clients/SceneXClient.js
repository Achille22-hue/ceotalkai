...
var autoFillFeatures = function (options) {
    ...
    if ((options === null || options === void 0 ? void 0 : options.json_schema) && features.includes('json') == false)
        features.push('json');
...
var SceneXClient = (function (_super) {
    ...
    SceneXClient.prototype.validatePayload = function (options) {
        var _a;
        var features = (_a = options === null || options === void 0 ? void 0 : options.features) !== null && _a !== void 0 ? _a : [];
        var isJson = features.includes('json');
        var isVQA = features.includes('question_answer');
        if (isJson && isVQA) {
            throw 'You cannot use both json and question_answer features at the same time';
        }
        if (isJson && !(options === null || options === void 0 ? void 0 : options.json_schema)) {
            throw 'You must provide a json_schema when using structured JSON output feature';
        }
        if (isVQA && !(options === null || options === void 0 ? void 0 : options.question)) {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.post('/describe', data)];
                    case 1:
                        rawOutput = _a.sent();
